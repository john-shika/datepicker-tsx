...
export class DateTimeReadOnly implements DateTimeReadOnlyImpl {
    ...
    public equals(other: DateTimeReadOnlyImpl): boolean {
        ...
        const check = TimeSpan.prototype.equals.apply(this, [other as unknown as TimeSpanImpl]);
        if (!check) return false;

        // const timeSpan = new TimeSpan(this.days, this.hours, this.minutes, this.seconds, this.ms, this.us, this.ns);
        // if (!timeSpan.equals(other as unknown as TimeSpanImpl)) return false;
